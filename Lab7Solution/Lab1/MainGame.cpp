...
void MainGame::drawGame()
{
	...
	//linkToon();
	//linkRimLighting();
	Texture texture("..\\res\\test.jpg"); //load texture
	...
	transform.SetRot(glm::vec3(90.0, counter * 5, 0.0));
	transform.SetScale(glm::vec3(0.03, 0.03, 0.03));
	eMapping.Bind();
	linkEmapping();
	mesh3.draw();
	mesh3.updateSphereData(*transform.GetPos(), 0.62);
